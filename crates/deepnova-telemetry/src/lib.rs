//! OpenTelemetry integration for deepnova.
//!
...
//! let _guard = deepnova_telemetry::TelemetryGuard::init(
//!     "deepnova",
//!     Some("http://localhost:4317"),
//! )?;
//!
//! // Or use stdout for local debugging
//! // let _guard = deepnova_telemetry::TelemetryGuard::init_stdout("deepnova")?;
//!
...
impl TelemetryGuard {
    ...
    pub fn init(service_name: &str, otlp_endpoint: Option<&str>) -> anyhow::Result<Self> {
        ...
        let tracer = tracer_provider.tracer("deepnova");
...
mod tests {
    ...
    fn init_stdout_does_not_panic() {
        ...
        let result = TelemetryGuard::init_stdout("deepnova-test");
