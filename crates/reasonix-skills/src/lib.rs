...
//!
//! ```no_run
//! use reasonix_skills::{SkillLoader, SkillTool};
//! use std::sync::Arc;
//!
...
//! let tools: Vec<Arc<dyn reasonix_core::Tool>> = skills
//!     .into_iter()
//!     .map(|s| Arc::new(SkillTool::new(s)) as Arc<dyn reasonix_core::Tool>)
//!     .collect();
//! ```
...
use reasonix_core::registry::Skill;
