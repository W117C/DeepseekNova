//! ratatui-based interactive terminal UI for deepnova.
//!
...
//!
//! ```no_run
//! use deepnova_tui::TuiRunner;
//! # use std::sync::Arc;
//! # struct DummyRunner;
//! # #[async_trait::async_trait]
//! # impl deepnova_core::runner::Runner for DummyRunner {
//! #     async fn run_stream(&self, _input: deepnova_core::runner::RunInput) -> anyhow::Result<deepnova_core::runner::RunEventStream> {
//! #         unreachable!()
//! #     }
//! # }
//! # #[tokio::main]
...
struct AppState {
    ...
    running: bool,
    pending_text: String,
    last_usage: Option<deepnova_core::chunk::Usage>,
}
...
fn truncate_str(s: &str, max: usize) -> String {
    if s.len() <= max {
        ...
        // P1 Fix: walk back to a valid UTF-8 character boundary
        let mut end = max;
