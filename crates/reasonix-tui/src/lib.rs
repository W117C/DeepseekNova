...
//!
//! ```no_run
//! use reasonix_tui::TuiRunner;
//! # use std::sync::Arc;
//! # struct DummyRunner;
//! # #[async_trait::async_trait]
//! # impl reasonix_core::runner::Runner for DummyRunner {
//! #     async fn run_stream(&self, _input: reasonix_core::runner::RunInput) -> anyhow::Result<reasonix_core::runner::RunEventStream> {
//! #         unreachable!()
//! #     }
//! # }
//! # #[tokio::main]
...
struct AppState {
    ...
    running: bool,
    pending_text: String,
    last_usage: Option<reasonix_core::chunk::Usage>,
}
