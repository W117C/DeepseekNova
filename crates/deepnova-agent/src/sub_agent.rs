...
async fn run_sub_agent_loop(
    ...
    for step in 0..max_steps {
        ...
        let validated = deepnova_provider::ValidatedRequest::new(&messages, &tool_refs).map_err(
            |violations| {
                for v in &violations {
...
\
    ...
    let validated = deepnova_provider::ValidatedRequest::new(&summary_msgs, &[])
...
mod tests {
    ...
    fn config_with_tools() {
        ...
        impl Tool for DummyTool {
            fn schema(&self) -> deepnova_core::ToolSchema {
                deepnova_core::ToolSchema {
